...
export default function DashboardSpam() {
    ...
    function handleLoadMore() {
        ...
        startTransition(async () => {
            ...
            try {
                const res = await axios.get<GetEmailsResult>(
                    `/api/gmail/inbox?mailbox=SPAM&pageToken=${encodeURIComponent(
                        nextPageToken,
                    )}`,
                    { withCredentials: true },
                );
            ...
            <section className="overflow-hidden rounded-2xl border border-border/70 bg-background shadow-sm">
                {isInitialLoading ? (
                    ...
                    <div className="px-6 py-12 text-center">
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Your spam preview will appear here once Gmail data
                            is available.
                        </p>
                    </div>
                ) : (
